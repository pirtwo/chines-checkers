...
/**
 * launch the DOM element in fullscreen mode.
 * @param {DOM} elm 
 */
export function launchIntoFullscreen(elm) {
    let req = null;
    if (elm.requestFullscreen) {
        req = elm.requestFullscreen();
    } else if (elm.mozRequestFullScreen) {
        req = elm.mozRequestFullScreen();
    } else if (elm.webkitRequestFullscreen) {
        req = elm.webkitRequestFullscreen();
    } else if (elm.msRequestFullscreen) {
        req = elm.msRequestFullscreen();
    }
